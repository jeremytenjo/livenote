...
import Form from '../components/Form_Login.js';
			...
			<div>
				<Wrapper>
					...
					<SignupCont style={blah}>
						<SubTitle>Log In with</SubTitle>
						<div>
							<SocialButtons onClick={this.loginFacebook} src={Facebook_img} alt={"Faceboo Login Button"}></SocialButtons>
							<SocialButtons onClick={this.loginGoogle} src={Google_img} alt={"Google Login Button"}></SocialButtons>
						</div>
